            ...
            <div class="row py-5">
                <div class="col-lg-5 col-md-12 col-sm-12 col-12 contact-details px-3 pt-lg-3 pr-lg-5">
                    @foreach($contacts as $contact)
                        ...
                        <h6 class="contact-detail email">
                            {{ trans('contacts::front.work_time') }}
                            <span>{{ $contact->working_time }}</span>
                        </h6>
                    @endforeach
                        <h6 class="contact-detail our-time">{{ trans('contacts::front.our_time') }} <span class="our-clock"></span></h6>
                        <h6 class="contact-detail curr-time">{{ trans('contacts::front.your_time') }} <span class="clock"></span></h6>
                </div>
